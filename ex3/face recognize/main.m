...
data = load('pcagabor.txt');

addpath UMAP/umap

% [reduction, ~, ~, ~]=run_umap(pca(gabor, NumComponents=80),'n_components',2,'min_dist',0.1,'n_neighbors',8)
[reduction, ~, ~, ~]=run_umap(data,'n_components',2,'min_dist',0.1,'n_neighbors',8);
